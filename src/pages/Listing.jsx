        ...
        <main>
            <Swiper slidesPerView={1} pagination={{ clickable: true }}>
                {listing.imgUrls.map((url, index) => (
                    <SwiperSlide key={index}>
                        ...
                        <img src={listing.imgUrls[index]} style={{ backgroundSize: 'cover' }} className="swiperSlideDiv" />
                    </SwiperSlide>
                ))}
            </Swiper>
            ...
            <div className="listingDetails">
                ...
                {auth.currentUser?.uid !== listing.useRef && (
                    <Link to={`/contact/${listing.useRef}?listingName=${listing.name}&listingLocation=${listing.location}`} className='primaryButton'>Contact Landlord</Link>
                )}
            </div>
        </main >)
}
