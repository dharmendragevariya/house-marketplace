            ...
            <main>
                <form onSubmit={onSubmit}>
                    ...
                    <div className="formButtons">
                        ...
                        <button className={!offer && offer !== null ? 'formButtonActive' : 'formButton'} type='button' id='offer' value={true} onClick={onMutate}>No</button>
                    </div>
                    ...
                    <button type='submit' className="primaryButton createListingButton">Edit Listing Listing</button>
                </form>
            </main>
        </div>
    )
